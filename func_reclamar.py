...
class Reclamacao():
    ...
    def selecionaCRUDReclamacao(self):
        ...
        self.filtroframe.place(relx=0.4, rely=0.05, anchor="n")
        
        # Cria e posiciona Labels
        lb1 = Label(self.filtroframe, text="Selecione uma operação: ")
        lb1.grid(row=0, column=0, padx=5, pady=20)
        
        # Cria e posiciona a combobox de escolha do CRUD
        opcoes = ["Inserir", "Ler", "Atualizar", "Deletar"]
        self.crudCombobox = ttk.Combobox(self.filtroframe, value=opcoes, width=10, state="readonly")
        self.crudCombobox.current(0)
        self.crudCombobox.grid(row=0, column=1, sticky=E, padx=5, pady=20)
    ...
    def controleCRUD(self):
        #self.ApagaTelaReclamacao()
        print(self.crudCombobox.get())
        if self.crudCombobox.get() == "Inserir":
            self.insereReclamacao()
        
    # Insere novas reclamações com Timestamp
    def insereReclamacao(self):
        print()
    # Exibe as reclamações na tela
    def consultaReclamacao(self):
        print()
    # Exibe as reclamações na tela
    ...
    #     self.aviso = Label(self.telaReclamacao, foreground='red')
    ...
    # def formataTelaReclamacao(self):
    #     # Cria uma janela e define suas principais configurações
    #     self.telaReclamacao = Tk()
    #     self.telaReclamacao.title("Recepção - Escolha uma Opção")
    #     self.telaReclamacao.wm_iconbitmap(camIco)
    #     self.telaReclamacao.focus_force()
    #     self.telaReclamacao.geometry(tam)
    ...
    #     self.camConsReclamacao = PhotoImage(file="Images\Botões\inicio_consultar.png", master=self.telaReclamacao)
    #     self.camVoltar = PhotoImage(file="Images\Botões\inicio_voltar.png", master=self.telaReclamacao)
    ...
    #     # Cria um frame para a entrada de datas
    #     self.filtroframe = LabelFrame(self.telaReclamacao, text = "Filtro de disponibilidade", padx=10)
    ...
    #     self.quartosdisp = LabelFrame(self.telaReclamacao, text = "Quartos", padx=10, pady=10)
